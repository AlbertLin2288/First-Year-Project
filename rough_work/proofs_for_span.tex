...
Case 2: $ker (T-xI)\neq \emptyset$\\
This in particular means $x$ is an eigenvalue for $T$, and $$\bigcup_{k\in \mathbb{N}} ker(T-xI)^k=G_x\subseteq W.$$
Let $$T_x:=T-xI \text{ and } d=dim\ G_x.$$Thus $ker(T_x^d)=G_x$.
