...
Almost all students studying in a STEM discipline are at some point taught some fundamental techniques of linear algebra.
Even within mathematics curricula these introductions to linear algebra terminate at most around the Jordan Canonical Form.
This however fails to make even enthusiastic students aware of the much larger world of intermediate to advanced linear algebra.

The Weierstrass Canonical Form (WCF) can present a stable stepping stone into this world of further linear algebra.
...
With this in mind this article, inspired majorly by \cite{berger2012quasi}, hopes to pick up where elementary knowledge of linear algebra left off and provide an exposition of the WCF.
