...
Therefore, instead of attempting to describe the maps $L$ and $T$ via a specific basis, we do so with two different bases $\beta$ and $\gamma$ with the corresponding matrices $$_\beta[T]_ \gamma $$ $$_\beta[L]_ \gamma$$
