...
\begin{proof}
    ...
    \begin{equation*}
        \img_{\vsS}B = B(\vsS) = B(B\inv(A(\vsS))) \subseteq A(\vsS)
    \end{equation*}

    Hence, for any $x\in\C$, we have
    \begin{equation*}
        \img_{\vsS}(A+Bx)\subseteq\img_{\vsS}A+\img_{\vsS}Bx=\img_{\vsS}A
    \end{equation*}
    And
    \begin{equation*}
        \dim\ker_{\vsS}(A+Bx)=\dim\vsS-\dim\img_{\vsS}(A+Bx)\ge\dim\vsS-\dim\img_{\vsS}A=\dim\ker_{\vsS}A>0
    \end{equation*}
...
\begin{proof}
    ...
    Hence, $\vsS_m=\ker((A+\lambda B)\inv B)^m$ and $\vsSp_m=\img((A+\lambda B)\inv B)^m$.
