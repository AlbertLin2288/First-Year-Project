...
Everything in draft\_proof.tex
...
A matrix pencil $\pen{A}{B}$ is singular if $|\pen{A}{B}|=0$, it is regular if it is not singular.

\section{relevent proof}

Alternative critia for singularity/regularity
