...
We begin with considering the eigenspaces. Let the eigenvalues be \(\lambda_1, \lambda_2,...,\lambda_\sigma\) for a linear operator \(T\) over \(\vsV\), and the corresponding eigenspaces
